...
void main() {
  ...
  group("Player", () {
    ...
    test("Choose and Play Card", () {
      ...
      customGame.players[0].play(customGame, fakeInput);
    ...
    test("Choose and Play Card Cant Be Played", () {
      ...
      customGame.players[0].play(customGame, fakeInputDoesNotWork, fakeInput);
    ...
    test("Play Card With Taget", () {
      ...
      customGame.players[0].playCard(customGame, 8, fakeInput);
    ...
    test("Play Card With Two Taget", () {
      ...
      customGame.players[0].playCard(customGame, 7, fakeInput, fakeInput2);
