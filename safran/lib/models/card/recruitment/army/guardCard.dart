...
class GuardCard extends ArmyCard {
  ...
  play(Game game, [List<int> targets = const []]) {
    if(game.battleMode && game.battleField.getUpCard().runtimeType == SpearmanCard) {
      int playerIndex = game.getPreviousPlayerTurnIndex();

      Logger.info("Player ${game.players[game.getPreviousPlayerTurnIndex()].userName} is countered by Guard");
